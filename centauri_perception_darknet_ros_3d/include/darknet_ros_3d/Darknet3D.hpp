...
private:
  ...
  void calculate_boxes(sensor_msgs::msg::PointCloud2 cloud_pc2, sensor_msgs::msg::PointCloud cloud_pc,
  ...
  void publish_isolated_pointcloud(sensor_msgs::msg::PointCloud2 input_cloud,
  ...
  void publish_pca_values(const Eigen::Matrix3f& eigen_vectors, const Eigen::Vector3f& eigen_values);

  void publish_frame_at_centroid(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr& isolated_cloud, const Eigen::Matrix3f& eigen_vectors, std::string working_frame_);
  ...
  rclcpp_lifecycle::LifecyclePublisher
  <visualization_msgs::msg::MarkerArray>::SharedPtr centroid_pub_;

  rclcpp_lifecycle::LifecyclePublisher
  <sensor_msgs::msg::PointCloud2>::SharedPtr isolated_cloud_pub_;

  rclcpp_lifecycle::LifecyclePublisher
  <geometry_msgs::msg::TransformStamped>::SharedPtr object_frame_pub_;
